...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](/en/api-playground/demo).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](/en/api-playground/demo)
        </ResponseField>
      </Expandable>
    </ResponseField>
